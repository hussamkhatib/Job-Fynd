...
const AplicationCard = ({ user, fieldValues, branch }: any) => {
  return (
    <div className="w-full max-w-sm h-studentcard mx-auto rounded-md shadow-md overflow-hidden py-2 flex flex-col justify-between bg-white">
      ...
      <div className="px-3 flex justify-between">
        ...
        {/* {fieldValues.linkedin.startsWith("https://www.linkedin.com/in/") && (
          <a href={fieldValues.linkedin} className="flex items-center">
            <svg
              fill="#2867B2"
